        ...
        settings: {
            'x-component-props': {
                ...
                maxBodyHeight: {
                    ...
                    tooltip: 'When Fixed Header is enabled, scroll bars will appear when the height exceeds this height',
                },
        ...
        settings: {
            'x-component-props': {
                ...
                alignHeader: {
                    ...
                    tooltip: 'If not set, the alignment will be the same as that of the Cell Alignment',
