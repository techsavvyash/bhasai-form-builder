        ...
        settings: {
            'x-component-props': {
                ...
                treeCheckable: {
                    ...
                    tooltip: 'Whether the tree in the drop-down box supports checking the check box of the node',
                },
                treeCheckStrictly: {
                    title: 'Tree Check Strictly',
                    tooltip: 'Check whether the node check box in the tree in the drop-down box is completely controlled (the selected status of parent and child nodes is no longer associated)',
                },
                treeCheckedStrategy: {
