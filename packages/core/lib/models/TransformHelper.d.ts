import { Point, IPoint, ISize, IRect, Rect } from '@samagrax/shared';
...
export declare class TransformHelper {
    ...
    get cursorDragNodesEdgeLines(): import("@samagrax/shared").IRectEdgeLines;
    get dragNodesRect(): Rect;
    get dragNodesEdgeLines(): import("@samagrax/shared").IRectEdgeLines;
