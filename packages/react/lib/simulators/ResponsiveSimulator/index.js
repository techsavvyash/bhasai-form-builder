...
import { DragStartEvent, DragMoveEvent, DragStopEvent, CursorDragType, } from '@samagrax/core';
import { calcSpeedFactor, createUniformSpeedAnimation } from '@samagrax/shared';
...
export const ResponsiveSimulator = observer((props) => {
    ...
    return (React.createElement("div", { ...props, className: cls(prefix, props.className), style: {
            height: '100%',
            width: '100%',
            minHeight: 100,
            position: 'relative',
